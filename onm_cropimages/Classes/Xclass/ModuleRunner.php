<?php
namespace ONM\OnmCropimages\Xclass;
...
class ModuleRunner extends \TYPO3\CMS\Extbase\Core\ModuleRunner {
	...
	public function callModule($moduleSignature) {
		...
		if (\TYPO3\CMS\Core\Utility\GeneralUtility::_GP('id')) {
			...
			//workaround:
			if (\TYPO3\CMS\Core\Utility\GeneralUtility::_GP('M') == 'file_OnmCropimagesCropimages' && preg_match('/[0-9]+\:\/.*/', \TYPO3\CMS\Core\Utility\GeneralUtility::_GP('id')) > 0) {
				$access = true;
			}
